...
//         const idea = Factory.create('idea');
//         assert.typeOf(idea, 'object');
//         assert.match(idea.name, /List /);
//       });
//     });
...
//         const list = Factory.create('idea', props);
//         _.times(3, () => {
